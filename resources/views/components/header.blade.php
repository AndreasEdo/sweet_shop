<nav class="w-full flex flex-wrap justify-between bg-white p-4">
  <div class="flex flex-wrap items-center gap-1 md:gap-20">
    ...
    <div class="flex gap-4 md:gap-20">
      ...
      <a href="{{route('products.index')}}" class="text-[#F8BBD0] text-xl md:text-3xl font-bold">List Product</a>
    </div>
  </div>
  <div class="flex items-center gap-4 md:gap-6 mt-4 md:mt-0">
    @if (Auth::guard('admin')->check())
        ...
        <div class="relative group inline-block">
            ...
            <div class="absolute left-0 mt-2 w-full bg-white rounded-md shadow-lg opacity-0 group-hover:opacity-100 group-hover:visible invisible transition-all duration-300 z-50">
                <ul class="py-2">
                    <li>
                        <a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 text-sm text-[#E91E63] hover:bg-pink-100 transition">Dashboard</a>
                    </li>
                    <li>
